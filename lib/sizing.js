...
export function xauCnyPerGram(xau, usdcny) {
  ...
  return round2(xauPrice * usd / TROY_OUNCE_GRAMS);
}

/** True when the international-converted CMB fallback estimate is usable. */
export function hasCmbFallback(xau, usdcny) {
