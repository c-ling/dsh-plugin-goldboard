  ...
  factory: function (require) {
    ...
    var DICT = {
      ...
      en: {
        ...
        statsTitle: "Replay diagnostics (v5)",
      ...
      return el("div", { className: "dsh-goldboard-settings" },
        ...
        el(CardRow, { title: format(t, "statsTitle"), hint: format(t, "statsHint") },
          ...
          statsReport ? el("div", { className: "dsh-goldboard-stats-summary" },
            el("span", null, format(t, "statsReportVersion", { version: statsReport.version || "?" })),
            el("span", null, format(t, "statsWindow", { from: (statsReport.window && statsReport.window.from) || "—", to: (statsReport.window && statsReport.window.to) || "—" })),
            el("span", null, format(t, "statsLane", { lane: String((statsReport.params && statsReport.params.lane) || "cmb") === "cmb" ? format(t, "statsLaneCmb") : format(t, "statsLaneAu9999") })),
            el("span", null, format(t, "statsDaysEvaluated", { evaluated: statsReport.daysEvaluated, requested: statsReport.daysRequested })),
            Number(statsReport.version) === 5 ? el("span", null, format(t, "statsCompleteDays", { count: statsReport.completeDays || 0 })) : null,
            Number(statsReport.version) === 5 && Number(statsReport.partialDays) > 0 ? el("span", null, format(t, "statsPartialDays", { count: statsReport.partialDays })) : null,
            el("span", null, format(t, "statsSteps", { count: statsReport.totals.steps })),
            el("span", null, format(t, "statsEvents", { count: statsReport.totals.directionalEvents })),
            Number(statsReport.version) === 5 ? el("span", null,
              Object.prototype.hasOwnProperty.call(statsReport.totals || {}, "unexecutedSignals")
                ? format(t, "statsUnexecutedCount", { count: Number(statsReport.totals.unexecutedSignals) || 0 })
                : format(t, "statsUnexecutedCountUnavailable")
            ) : null,
            el("span", null, format(t, "statsBlocked", { ratio: statsPct(statsReport.totals.coverageBlockedRatio) })),
          ...
          statsReport && !statsOverallOf(statsReport) ? el("div", { className: "dsh-goldboard-hint" }, format(t, "statsLegacyReport", { version: statsReport.version || "?" })) : null,
          statsReport && Number(statsReport.version) === 5 ? el("div", { className: "dsh-goldboard-stats-summary" },
            ...
            el("span", null, format(t, "statsAmbiguousBars", { count: statsReport.ambiguousBarCount || 0 })),
          ...
          statsReport ? el("div", null,
            ...
            el("ul", { className: "dsh-goldboard-stats-caveats" },
              (statsReport.caveats || []).map(function (code) {
                return el("li", { key: code }, format(t, "caveat_" + String(code).replace(/-/g, "_")));
              })),
          ) : null,
        ),
