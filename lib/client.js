    ...
    function SettingsSection(props) {
      ...
      var saveViaSettings = function () {
        if (!settingsApi || !settingsApi.settings || typeof settingsApi.settings.mutate !== "function") {
          setStatus(format(t, "saveError", { error: "settings transport unavailable" }));
          return;
        }
        ...
        settingsApi.settings.mutate(request)
          .then(function (response) {
            ...
            if (result.ok) {
              ...
              setStatus(format(t, "saveError", { error: (result.error && result.error.message) || "settings write failed" }));
            }
          })
          .catch(function (err) {
            setSaving(false);
