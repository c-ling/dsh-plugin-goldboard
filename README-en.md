...
```sh
dsh plugin --profile web add "github:c-ling/dsh-plugin-goldboard#v1.3.1"
# or: npx @deepseek-ai/dsh plugin --profile web add "github:c-ling/dsh-plugin-goldboard#v1.3.1"
# or: cd ~/.dsh/profiles/web && corepack pnpm add "github:c-ling/dsh-plugin-goldboard#v1.3.1"
```

Re-running the install command with the new `#v1.3.1` pin upgrades the dependency; the loader row in `cordis.patch.yml` stays unchanged. Restart `dsh web`, then hard-refresh.
